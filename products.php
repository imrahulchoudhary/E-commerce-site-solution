                ...
                <div class="col-md-3 col-sm-6 home-feature">
                 ...
                 <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            <h3>Sparx Men's Sx0406g Running Shoes</h3>
                            <p>Price Rs.499.00</p>
                            <?php if (!isset($_SESSION['email'])) { ?>
                                <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                <?php
                 ...
                 <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        <img src="img/shoes-1058419_1920.jpg" alt="">
                        <div class="caption">
                            <h3>Adidas Men's Throb M Running Shoes</h3>
                 ...
                 <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        <img src="img/shoes-825674_1920.jpg" alt="">
                        <div class="caption">
                            <h3>Sparx Men SM-482 Sports Shoes</h3>
                 ...
                 <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        <img src="img/sneakers-1306116_1920.jpg" alt="">
                        <div class="caption">
                            <h3>Power Men's Aero Running Shoes</h3>
