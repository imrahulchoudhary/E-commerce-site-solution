    ...
    <body>
        ...
        <div class="container" id="content">
            ...
            <div class="jumbotron home-spacer" id="products-jumbotron">
                ...
                <p>We have the best Xiaomi Smartphone & Samsung Galaxy Smartphones  for you. No need to hunt around, we have all in one place.</p>
            ...
            <div class="row text-center" id="cameras">
                <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        <img src="img/m40.jpg" alt="">
                        <div class="caption">
                            <h3>MI Redmi Note 7S (Black)</h3>
                ...
                <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        <img src="img/m3b.jpg" alt="">
                        <div class="caption">
                            <h3>Redmi 8A Dual (2GB RAM,32GB Storage)</h3>
                            <p>Price: Rs. 7,000.00 </p>
                            <?php if (!isset($_SESSION['email'])) { ?>
                                <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                <?php
                            } else {
                ...
                <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        <img src="img/note10 lite.jpg" alt="">
                        <div class="caption">
                            <h3>Redmi Note 8 Pro(G90TProcessor)</h3>
                ...
                <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        <img src="img/m51.jpg" alt="">
                        <div class="caption">
                            <h3>Redmi K20Pro(6GB RAM)</h3>
                            <p>Price: Rs. 50000.00</p>
                            <?php if (!isset($_SESSION['email'])) { ?>
                                <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                <?php
            ...
            <div class="row text-center" id="watches">
                <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        <img src="img/K20 Pro.jpg" alt="">
                        <div class="caption">
                            <h3>Redmi K20 Pro(Flame Red) </h3>
                            <p>Price: Rs. 23990.00 </p>
                            <?php if (!isset($_SESSION['email'])) { ?>
                                <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                <?php
                            } else {
                ...
                <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        <img src="img/K20 Pro1.jpg" alt="">
                        <div class="caption">
                            <h3>Redmi K20 Pro(Pearl White)</h3>
                            <p>Price: Rs. 23779.00 </p>
                            <?php if (!isset($_SESSION['email'])) { ?>
                                <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                <?php
                            } else {
                ...
                <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        <img src="img/K20 Pro2.jpg" alt="">
                        <div class="caption">
                            <h3>Redmi K20 Pro(Glacier Blue)</h3>
                            <p>Price: Rs. 23999.00 </p>
                            <?php if (!isset($_SESSION['email'])) { ?>
                                <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                <?php
                            } else {
                ...
                <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        <img src="img/K20 Pro3.jpg" alt="">
                        <div class="caption">
                            <h3>Redmi Note 8 Pro(Halo White)</h3>
            ...
            <div class="row text-center" id="shirts">
                <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        <img src="img/K20 Pro4.jpg" alt="">
                        <div class="caption">
                            <h3>Redmi 8A Dual(Midnight Grey)</h3>
                            <p>Price: Rs. 7999.00 </p>
                            <?php if (!isset($_SESSION['email'])) { ?>
                                <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                <?php
                            } else {
                ...
                <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        <img src="img/K20 Pro5.jpg" alt="">
                        <div class="caption">
                            <h3>Redmi 8A Dual(Sea Blue)</h3>
                            <p>Price: Rs. 11,999.00</p>
                            <?php if (!isset($_SESSION['email'])) { ?>
                                <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                <?php
                            } else {
                ...
                <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        <img src="img/mi a3.jpg" alt="">
                        <div class="caption">
                            <h3>Xiaomi Mi A3 (Not Just Blue)</h3>
                ...
                <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        <img src="img/readmi 7.jpg" alt="">
                        <div class="caption">
                            <h3>Redmi 7 (Lunar Red, 3GB RAM)</h3>
                 ...
                 <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        <img src="img/m21.jpg" alt="">
                        <div class="caption">
                            <h3>Samsung Galaxy M3</h3>
                            <p>Price Rs. 16999</p>
                            <?php if (!isset($_SESSION['email'])) { ?>
                                <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                <?php
                 ...
                 <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        <img src="img/m31.jpg" alt="">
                        <div class="caption">
                            <h3>Samsung Galaxy M2 </h3>
                 ...
                 <div class="col-md-3 col-sm-6 home-feature">
                    <div class="thumbnail">
                        <img src="img/readmi y3.jpg" alt="">
                        <div class="caption">
                            <h3>Samsung Galaxy M3</h3>
                            <p>Price Rs. 13499.00</p>
                            <?php if (!isset($_SESSION['email'])) { ?>
                                <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                <?php
                            } else {
